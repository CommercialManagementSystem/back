	...
	return func(c *gin.Context) {
		...
		if method == http.MethodPost || method == http.MethodPut {
			...
			if mediaType != "multipart/form-data" {
				if v, ok := c.Get(warpper.ReqBodyKey); ok {
